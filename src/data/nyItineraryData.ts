  ...
  },
  {
    ...
    stops: [
      ...
      },
      {
        id: "d3-15",
        order: 15,
        name: "Devolución de bicicletas (Bike Rental - Zona AMNH)",
        time: "13:00",
        lat: 40.783,
        lng: -73.9765,
        imageUrl: wiki.bikeRental,
        walkFromPrev: "🚲 5 min en bici (600 m) saliendo de Central Park por 79th/81st St hacia la sucursal del rental",
        tip: "Entrega de bicicletas y cascos en la sucursal del Upper West Side / zona del Museo. Tiempo para un almuerzo rápido antes de entrar al AMNH.",
      ...
      },
      {
        ...
        walkFromPrev: "🚶 3 min a pie (250 m) cruzando hacia la entrada del Museo",
        tip: "Entrada alrededor de las 13:30 hs para aprovechar ~3.5 a 4 horas completas. Salas imperdibles: Dinosaurios, Ballena Azul y Planetario Hayden (Gilder Center).",
        note: "Visita principal (~4 h)",
        price: "$28 USD",
      },
      {
        id: "d3-17",
