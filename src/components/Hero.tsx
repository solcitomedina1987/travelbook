...
export function Hero() {
  return (
    ...
    >
      <Image
        src="https://images.unsplash.com/photo-1485871981521-5b1fd3805ebe?auto=format&fit=crop&w=2400&q=80"
        alt="Skyline de Nueva York"
        fill
        priority
      ...
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,rgba(13,148,136,0.22),transparent_50%)]" />
      ...
      <div className="relative z-10 mx-auto w-full max-w-7xl px-4 pb-16 pt-28 sm:px-6 sm:pb-20 lg:px-8 lg:pb-24">
        ...
        <motion.h1
          ...
          className="mt-3 max-w-4xl font-display text-3xl font-semibold leading-tight tracking-tight text-offwhite sm:text-4xl md:text-5xl lg:text-6xl"
        >
          {tripMeta.heroTitle}
        </motion.h1>
        ...
        <motion.p
          ...
          className="mt-5 max-w-xl text-base text-offwhite/75 sm:text-lg"
        >
          {tripMeta.dateRange}
        </motion.p>
